...
class DQNAgent(AbstractDQNAgent):
    ...
    def __init__(self, model, policy=None, test_policy=None, enable_double_dqn=False,
                 ...
                 nb_max_steps_recurrent_unrolling=100,
                 enable_dueling_network=False, dueling_type='avg', *args, **kwargs):
    ...
    def compile(self, optimizer, metrics=[]):
        ...
        loss_out = Lambda(clipped_masked_error, output_shape=output_shape, name='loss')([y_true, y_pred, mask])
