...
from rl.processors import DiscreteInputRNNProcessor
...
def test_recurrent_dqn():
    ...
    model = Sequential()
    model.add(LSTM(16, return_sequences=True, stateful=True, batch_input_shape=(batch_size,2,1)))
    ...
    processor = DiscreteInputRNNProcessor()
